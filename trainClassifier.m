...
% Auto-generated by MATLAB on 29-May-2017 00:11:06
...
predictorNames = {'id', 'year', 'month', 'day', 'gender', 'age', 'svip_valid', 'vip_valid', 'feed_count', 'book_count', 'music_count', 'movie_count', 'indeg', 'outdeg'};
predictors = inputTable(:, predictorNames);
response = inputTable.spam;
...
trainedClassifier.RequiredVariables = {'id', 'year', 'month', 'day', 'gender', 'age', 'svip_valid', 'vip_valid', 'feed_count', 'book_count', 'music_count', 'movie_count', 'indeg', 'outdeg'};
