...
title('Users by Gender Refurbished in Test Set')
saveas(gcf,'Gender_Analysis_refurbished_test','jpeg');
...
figure;
hist(Age,nbins_1);
title('Users by Age Refurbished in Test Set')
xlabel('Age')
ylabel('User numbers')
saveas(gcf,'Age_histogram_refurbished_test','jpeg');
...
title('Users Among Different Age Groups Refurbished in Test Set')
saveas(gcf,'Age_group_refurbished_test','jpeg')
...
set(l,'FontSize',16)
title('Average Book/Movie/Music Collections among Different Age Group Refurbished in Test Set');
set(gca, 'XTickLabel',str,'XTick',1:numel(str));
saveas(gcf,'Avg_book_movie_music_collections_refurbished_test','jpeg')
...
title('Average Comments Received/Given by Different Genders Refurbished in Test Set')
set(gca,'XTickLabel',str);
saveas(gcf,'comments_by_gender_refurbished_test','jpeg');
